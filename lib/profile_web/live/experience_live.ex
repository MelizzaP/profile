defmodule ProfileWeb.ExperienceLive do
  ...
  def render(assigns) do
    ~H"""
    <div :for={job <- @experience} class="p-4 mb-4 border-b-2 border-b-biege-light">
      ...
      <ul class="flex justify-between w-full border-y border-biege-dark my-4 p-1 text-biege-dark">
